...
export class Room {
    ...
    /** The autostart state of the room */ auto;
    /** The autostart config of the room */ autoStart;
    ...
    /** The room config. Note that TETR.IO does not send all options when joining a room, and some properties may not be present (hence the `Partial`) */ options;
    ...
    /** Whether or not the room allows anonymous users */ allowAnonymous;
    /** Whether or not the room allows unranked users */ allowUnranked;
    /** Whether or not the room allows users queued for TL */ allowQueued;
    /** Whether or not the room allows bots */ allowBots;
    /** The user rank limit to play in the room */ userRankLimit;
    /** Whether or not to use best rank as limit */ useBestRankAsLimit;
    /** The background image of the lobby */ lobbybg;
    /** The background music of the lobby */ lobbybgm;
    /** The background music of the game */ gamebgm;
    /** Whether or not to force require XP to chat */ forceRequireXPToChat;
    /** The list of available BGMs */ bgmList;
    /** The room constants */ constants;
    /** Whether or not chatting is allowed */ allowChat;
    ...
    #init() {
        ...
        this.#hook.on("client.game.end", ()=>this.replay?.end({
   ...
   */ async spectate() {
        ...
        const spectateData = await this.#client.wrap("game.spectate", undefined, "game.spectate");
        this.#client.game = new Game(this.#client, spectateData.players);
        return {
            match: spectateData.match.rb.options,
            players: spectateData.match.rb.leaderboard.map((p)=>({
                    active: p.active,
