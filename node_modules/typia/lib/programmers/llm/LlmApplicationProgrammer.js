...
(function (LlmApplicationProgrammer) {
    ...
    LlmApplicationProgrammer.write = (props) => {
        ...
        return {
            config: Object.assign(Object.assign({}, LlmSchemaComposer_1.LlmSchemaComposer.getConfig(props.config)), { separate: null, validate: null }),
    ...
    const writeFunction = (props) => {
        ...
        if (output === null)
            return null;
        if (output &&
            openapi_1.LlmTypeChecker.isReference(output) === false &&
