import { type BagType, Engine, type KickTable, Mino as EngineMino } from "../engine";
export declare namespace Game {
    ...
    type GameOverReason = "topout" | "garbagesmash" | "zenith" | "clear" | "topout_clear" | "winner" | "forfeit" | "retry" | "drop" | "dropnow" | "disconnect";
    interface Options {
        version: number;
        seed_random: boolean;
        seed: number;
    ...
    namespace IGEs {
        type all = Target | Targeted | AllowTargeting | Interaction | KEV;
        interface Target {
            type: "target";
            data: {
                targets: number[];
    ...
    interface Scoreboard extends LeaderboardBase {
        alive: boolean;
        lifetime: number;
    }
    interface RB {
    ...
    namespace Replay {
        namespace Frames {
            type all = Start | Full | IGEFrame | Keypress | End | Strategy | ManualTarget;
            interface Start {
                type: "start";
    ...
    type Mino = EngineMino;
    type BoardSquare = Mino | null;
    /** @deprecated */
    namespace Client {
        /** @deprecated */
