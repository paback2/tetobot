...
class Relationship {
    ...
    constructor(options, social, client, lazyLoad = Relationship.lazyLoadDms){
        this.id = options.id;
        ...
        this.#client = client;
        this.dms = [];
        this.ready = lazyLoad ? new Promise(()=>{}) : this.loadDms().then(()=>{});
    }
    /**
   ...
   */ snapshot() {
        return {
            avatar: this.avatar,
            dms: (0, _engine.deepCopy)(this.dms),
   ...
   */ static fromSnapshot(snapshot, social, client) {
        ...
        relationship.ready = new Promise((r)=>r());
        relationship.dms = (0, _engine.deepCopy)(snapshot.dms);
